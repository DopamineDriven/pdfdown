...
let __wasmFilePath = __nodePath.join(__dirname, 'pdfdown.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'pdfdown.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = __nodePath.resolve('@d0paminedriven/pdfdown-wasm32-wasi')
  } catch {
    throw new Error('Cannot find pdfdown.wasm32-wasi.wasm file, and @d0paminedriven/pdfdown-wasm32-wasi package is not installed.')
  }
}
...
module.exports.extractStructuredTextPerPage = __napiModule.exports.extractStructuredTextPerPage
module.exports.extractStructuredTextPerPageAsync = __napiModule.exports.extractStructuredTextPerPageAsync
